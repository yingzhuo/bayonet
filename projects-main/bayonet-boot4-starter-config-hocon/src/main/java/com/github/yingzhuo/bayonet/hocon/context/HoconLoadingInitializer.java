...
/**
 * 在 Spring 容器初始化前加载外部 HOCON 配置文件，将其注册到 {@code Environment} 的 {@code PropertySource} 中。
 ...
 */
@Slf4j
public class HoconLoadingInitializer extends AbstractApplicationContextInitializer {
