...
import com.github.yingzhuo.bayonet.jwt.service.DefaultJwtValidator;
...
public interface BlacklistManager {
     ...
     * @param jti      JWT ID（JWT payload 中的 {@code jti} 声明），可能为 {@code null}
     */
    void add(String rawToken, @Nullable String jti);
     ...
     * @param jti      JWT ID（JWT payload 中的 {@code jti} 声明），可能为 {@code null}
     */
    void remove(String rawToken, @Nullable String jti);
